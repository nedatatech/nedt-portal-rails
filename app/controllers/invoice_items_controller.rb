class InvoiceItemsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @invoice_item.save
        format.html { redirect_to edit_invoice_path(@invoice_item.invoice_id), notice: 'Invoice item was successfully created.' }
  ...
  def update    
    respond_to do |format|
      if @invoice_item.update(invoice_item_params)
        format.html { redirect_to edit_invoice_path(@invoice_item.invoice_id), notice: 'Invoice item was successfully updated.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to edit_invoice_path(@invoice_item.invoice_id), notice: 'Invoice item was successfully destroyed.' }
  ...
  private
    ...
    def invoice_item_params
      params.require(:invoice_item).permit(:invoice_id, :inventory_item_id, :quantity)
    end
end
